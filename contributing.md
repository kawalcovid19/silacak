...
Most contributions start from defining issues. Anyone can open an issue for discussion. You can head to [this link](https://github.com/kawalcovid19/silacak/issues) for deep understanding about Issues. Specifically, you can start finding several Issues in [our Issues tab](https://github.com/kawalcovid19/silacak/issues). There are only two categories in Issues section, Open and Closed.
...
1. The easiest way is to go into the `github.com/<owner>/<repository>/contribute` link. In this case, you can go into [this link](https://github.com/kawalcovid19/silacak/contribute). That link will list all of the issues with the `good first issue` label.
2. Another way is to head over into the [Issues](https://github.com/kawalcovid19/silacak/issues) section of the repository, then click the Labels section beside Milestones. There you can see a lot of labels for the issues in the repository. Then find and click the `good first issue` label.
...
Please open an issue on [`kawalcovid19/silacak`](https://github.com/kawalcovid19/silacak/issues) if you have suggestions for new labels.
